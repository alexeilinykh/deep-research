...
export const createClarificationRequest = (
  ctx: SystemContext,
  reason: string,
  langfuseTraceId?: string,
  ...
  return streamText({
    ...
    system: `You are a helpful clarification agent for a DeepSearch system. Your job is to ask the user for clarification on their question in a friendly and helpful way.

Guidelines:
- Be polite and conversational
- Explain why clarification would help provide a better answer
- Suggest specific aspects that need clarification
- Keep the tone friendly and not overly formal
- Make it clear you're trying to help them get the best possible answer`,
...
Please reply to the user with a helpful clarification request that will help them get a much better answer from the search system.`,
  });
};
