...
export type SummarizeURLParams = {
  url: string;
  title: string;
  snippet: string;
  date: string;
...
Please provide a detailed synthesis focused on the research topic:`;
...
export const summarizeURL = cacheWithRedis("summarize_url", _summarizeURL);
